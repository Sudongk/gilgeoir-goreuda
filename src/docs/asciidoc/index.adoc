...
=== 리뷰 생성 (POST /api/v1/reviews/stores/{storeId})

==== Request
include::{snippets}/review-controller-test/create-review-success/http-request.adoc[]
include::{snippets}/review-controller-test/create-review-success/path-parameters.adoc[]
include::{snippets}/review-controller-test/create-review-success/request-fields.adoc[]
include::{snippets}/review-controller-test/create-review-success/request-headers.adoc[]

==== Response
include::{snippets}/review-controller-test/create-review-success/http-response.adoc[]


=== 리뷰 수정 (PUT /api/v1/reviews/stores/{storeId})

==== Request
include::{snippets}/review-controller-test/update-review-success/http-request.adoc[]
include::{snippets}/review-controller-test/update-review-success/path-parameters.adoc[]
include::{snippets}/review-controller-test/update-review-success/request-fields.adoc[]
include::{snippets}/review-controller-test/update-review-success/request-headers.adoc[]

==== Response
include::{snippets}/review-controller-test/update-review-success/http-response.adoc[]


=== 리뷰 삭제 (DELETE /api/v1/reviews/stores/{storeId})

==== Request
include::{snippets}/review-controller-test/delete-review-success/http-request.adoc[]
include::{snippets}/review-controller-test/delete-review-success/path-parameters.adoc[]
include::{snippets}/review-controller-test/delete-review-success/request-headers.adoc[]

==== Response
include::{snippets}/review-controller-test/delete-review-success/http-response.adoc[]


=== 리뷰 조회 (GET /api/v1/reviews/stores/{storeId})

==== Request
include::{snippets}/review-controller-test/get-reviews-success/http-request.adoc[]
include::{snippets}/review-controller-test/get-reviews-success/query-parameters.adoc[]

==== Response
include::{snippets}/review-controller-test/get-reviews-success/http-response.adoc[]
include::{snippets}/review-controller-test/get-reviews-success/response-fields.adoc[]


== 리뷰 댓글 API

=== 리뷰 댓글 생성 (POST /api/v1/reviews/{reviewId}/comments)

==== Request
include::{snippets}/review-controller-test/create-review-comment-success/http-request.adoc[]
include::{snippets}/review-controller-test/create-review-comment-success/path-parameters.adoc[]
include::{snippets}/review-controller-test/create-review-comment-success/request-fields.adoc[]
include::{snippets}/review-controller-test/create-review-comment-success/request-headers.adoc[]

==== Response
include::{snippets}/review-controller-test/create-review-comment-success/http-response.adoc[]


=== 리뷰 댓글 수정 (PUT /api/v1/reviews/comments/{commentId})

==== Request
include::{snippets}/review-controller-test/update-review-comment-success/http-request.adoc[]
include::{snippets}/review-controller-test/update-review-comment-success/path-parameters.adoc[]
include::{snippets}/review-controller-test/update-review-comment-success/request-fields.adoc[]
include::{snippets}/review-controller-test/update-review-comment-success/request-headers.adoc[]

==== Response
include::{snippets}/review-controller-test/update-review-comment-success/http-response.adoc[]


=== 리뷰 댓글 삭제 (DELETE /api/v1/reviews/comments/{commentId})

==== Request
include::{snippets}/review-controller-test/delete-review-comment-success/http-request.adoc[]
include::{snippets}/review-controller-test/delete-review-comment-success/path-parameters.adoc[]
include::{snippets}/review-controller-test/delete-review-comment-success/request-headers.adoc[]

==== Response
include::{snippets}/review-controller-test/delete-review-comment-success/http-response.adoc[]
